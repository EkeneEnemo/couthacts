  ...
  const courses = [
    {
      ...
      lessons: [
        { title: "Welcome to CouthActs — How the Platform Works", order: 1, durationMins: 15, content: "CouthActs is a global transportation infrastructure platform connecting customers with verified providers across 18 transport modes." },
        { title: "Setting Up Your Provider Profile", order: 2, durationMins: 15, content: "Your provider profile is your storefront. Complete it with business name, transport modes, service areas, and certifications." },
        { title: "Getting Verified — KYC and KYB", order: 3, durationMins: 15, content: "Identity verification is mandatory. KYC costs $20 via Persona. KYB requires business documentation for non-solopreneurs." },
        { title: "Understanding the CouthActs Score", order: 4, durationMins: 15, content: "Your 0-100 score determines your tier: Elite (90+), Trusted (75-89), Established (60-74), Probation (<60)." },
        { title: "How to Find and Bid on Jobs", order: 5, durationMins: 15, content: "Browse Jobs shows postings matching your modes. Bid competitively with relevant experience in your message." },
        { title: "Instant Jobs — Real-Time Requests", order: 6, durationMins: 15, content: "Instant matching for taxi, limo, and courier. 90-second acceptance window. First verified provider wins." },
        { title: "Getting Paid — Escrow and Stripe Connect", order: 7, durationMins: 15, content: "Escrow holds funds until both parties confirm. Withdraw via Stripe Connect. Minimum $10 withdrawal." },
        { title: "Your First 30 Days", order: 8, durationMins: 15, content: "Day 1-3: verify. Day 4-7: small local jobs. Day 8-14: increase volume. Day 15-30: optimize your score." },
      ],
      examQuestions: [
        ...
        { question: "How many points does verification add to your score?", optionA: "5", optionB: "10", optionC: "15", optionD: "20", correctAnswer: "C", explanation: "Full verification (KYC + KYB) adds 15 bonus points.", order: 9 },
    ...
    },
    {
      ...
      description: "Master safety protocols across all transport modes. DOT, FMCSA, IMO, and FAA compliance.",
      whatYouLearn: ["Pre-trip inspection protocols", "FMCSA Hours of Service compliance", "Accident prevention and emergency response", "Cargo securement standards", "Weather hazard decision-making", "Safety documentation"],
...
Safety is not a department. It is not a regulation. It is not a course. It is a **commitment** — one you make every morning when you start your engine, and one that defines the kind of professional you are. Make it count.` },
      ...
      examQuestions: [
        ...
        { question: "Maximum driving hours after 10 hours off duty?", optionA: "8 hours", optionB: "10 hours", optionC: "11 hours", optionD: "14 hours", correctAnswer: "C", explanation: "11-Hour Driving Limit after 10 consecutive hours off duty.", order: 2 },
        { question: "Minimum WLL for tiedowns relative to cargo weight?", optionA: "25%", optionB: "50%", optionC: "75%", optionD: "100%", correctAnswer: "B", explanation: "FMCSA 393.100 requires at least 50% of cargo weight.", order: 3 },
        { question: "At what speed can hydroplaning occur?", optionA: "25 mph", optionB: "35 mph", optionC: "45 mph", optionD: "55 mph", correctAnswer: "B", explanation: "Hydroplaning can occur at speeds as low as 35 mph.", order: 4 },
        { question: "Which tracking layer do maritime bookings use?", optionA: "MOBILE_GPS", optionB: "FLIGHT_TRACKING", optionC: "AIS_MARITIME", optionD: "SATELLITE", correctAnswer: "C", explanation: "Maritime bookings use AIS_MARITIME.", order: 5 },
        { question: "What protection tier is required for HAZMAT?", optionA: "Basic", optionB: "Standard", optionC: "Premium", optionD: "Elite", correctAnswer: "D", explanation: "Elite Protection is mandatory for HAZMAT.", order: 6 },
        { question: "How many reflective triangles behind a stopped CMV?", optionA: "1", optionB: "2", optionC: "3", optionD: "4", correctAnswer: "C", explanation: "Three triangles at 10, 100, and 200 feet.", order: 7 },
        { question: "Which layer provides temperature monitoring?", optionA: "MOBILE_GPS", optionB: "IOT_DEVICE", optionC: "SATELLITE", optionD: "BIOMETRIC", correctAnswer: "B", explanation: "IOT_DEVICE provides temperature and condition monitoring.", order: 8 },
        { question: "What IMO convention governs safety at sea?", optionA: "MARPOL", optionB: "SOLAS", optionC: "STCW", optionD: "ISM", correctAnswer: "B", explanation: "SOLAS is the most important maritime safety treaty.", order: 9 },
        { question: "What CouthActs feature is used in critical emergencies?", optionA: "Tracking update", optionB: "Dispute filing", optionC: "SOS feature", optionD: "Customer message", correctAnswer: "C", explanation: "SOS escalates immediately to the operations team.", order: 10 },
      ],
    },
    {
      title: "Hazardous Materials Handling",
      slug: "hazardous-materials-handling",
      description: "Comprehensive HAZMAT training: classification, packaging, documentation, placarding, emergency response, and CouthActs HAZMAT workflows.",
      whatYouLearn: ["9 HAZMAT classes", "Packaging per 49 CFR 173", "Shipping paper preparation", "Emergency Response Guidebook", "CouthActs HAZMAT tracking workflows", "IoT condition monitoring"],
      ...
      lessons: [
        { title: "HAZMAT Classification — The 9 Classes", order: 1, durationMins: 20, content: "Class 1 Explosives, Class 2 Gases, Class 3 Flammable Liquids, Class 4 Flammable Solids, Class 5 Oxidizers, Class 6 Toxic, Class 7 Radioactive, Class 8 Corrosives, Class 9 Miscellaneous." },
        { title: "Packaging Requirements per 49 CFR 173", order: 2, durationMins: 20, content: "Performance-Oriented Packaging Standards. Packing Groups I (great danger), II (medium), III (minor)." },
        { title: "Shipping Papers and Documentation", order: 3, durationMins: 20, content: "Proper Shipping Name, Hazard Class, UN/NA number, Packing Group, quantity, emergency contact." },
        { title: "Placarding and Marking Requirements", order: 4, durationMins: 20, content: "Diamond-shaped signs on all four sides. 250mm minimum. Table 1 vs Table 2 materials." },
        { title: "Loading, Unloading, and Compatibility", order: 5, durationMins: 20, content: "49 CFR 177.848 Segregation Chart. Oxidizers cannot be loaded with flammable liquids." },
        { title: "Emergency Response Guidebook (ERG)", order: 6, durationMins: 20, content: "Yellow pages for UN numbers, blue for names, orange for guides, green for isolation distances." },
        { title: "HAZMAT Tracking and IoT on CouthActs", order: 7, durationMins: 20, content: "MOBILE_GPS + IOT_DEVICE + GEOFENCE + SATELLITE + QR_PIN + DOCUMENT_POD_AI for full chain of custody." },
        { title: "HAZMAT Certification and Compliance", order: 8, durationMins: 20, content: "CouthActs certification badge. Supplements CDL HAZMAT endorsement. Unlocks HAZMAT job bidding." },
      ],
      examQuestions: [
        { question: "How many HAZMAT classes under the UN system?", optionA: "6", optionB: "7", optionC: "8", optionD: "9", correctAnswer: "D", explanation: "9 classes of hazardous materials.", order: 1 },
        { question: "Which Packing Group indicates greatest danger?", optionA: "PG I", optionB: "PG II", optionC: "PG III", optionD: "PG IV", correctAnswer: "A", explanation: "Packing Group I = greatest danger.", order: 2 },
        { question: "Green-bordered ERG pages are for?", optionA: "Material ID", optionB: "Guide numbers", optionC: "Isolation distances", optionD: "First aid", correctAnswer: "C", explanation: "Green pages provide Initial Isolation and Protective Action Distances.", order: 3 },
        { question: "Which class must never be loaded with flammable liquids?", optionA: "Class 3", optionB: "Class 5.1 Oxidizers", optionC: "Class 8", optionD: "Class 9", correctAnswer: "B", explanation: "Oxidizers + flammable liquids = fire/explosion risk.", order: 4 },
        { question: "Which tracking layer provides temperature monitoring?", optionA: "MOBILE_GPS", optionB: "AIS_MARITIME", optionC: "IOT_DEVICE", optionD: "SATELLITE", correctAnswer: "C", explanation: "IOT_DEVICE provides temperature, humidity, shock sensors.", order: 5 },
        { question: "Where must shipping papers be when driver is out?", optionA: "Glove box", optionB: "Driver seat or door holder", optionC: "Trailer", optionD: "Container", correctAnswer: "B", explanation: "On the driver's seat or in a holder on the driver's door.", order: 6 },
        { question: "Minimum size for HAZMAT placards?", optionA: "150mm", optionB: "200mm", optionC: "250mm", optionD: "300mm", correctAnswer: "C", explanation: "250mm x 250mm minimum.", order: 7 },
        { question: "Protection tier required for HAZMAT on CouthActs?", optionA: "Basic", optionB: "Standard", optionC: "Premium", optionD: "Elite", correctAnswer: "D", explanation: "Elite Protection is mandatory.", order: 8 },
      ],
    },
    {
      title: "Customer Excellence Program",
      slug: "customer-excellence-program",
      description: "Communication, service delivery, and relationship management skills that earn 5-star reviews and build repeat business.",
      whatYouLearn: ["Communication protocols for 5-star reviews", "Proactive tracking updates", "Complaint handling and service recovery", "Building repeat customers", "CouthActs Score optimization", "Time management for on-time delivery"],
      ...
      lessons: [
        { title: "Why Customer Excellence Matters", order: 1, durationMins: 20, content: "Review Average = 20 out of 100 CouthActs Score points. Reputation earns more than price cuts." },
        { title: "Communication Protocols for Every Phase", order: 2, durationMins: 20, content: "Bidding, acceptance, pre-pickup, pickup, in-transit, delivery, post-delivery — each has specific communication standards." },
        { title: "Proactive Tracking as Communication", order: 3, durationMins: 20, content: "Use DOCUMENT_POD_AI for photos, QR_PIN for handoffs, status notes on every tracking event." },
        { title: "Handling Complaints — LAST Framework", order: 4, durationMins: 20, content: "Listen, Apologize, Solve, Thank. Resolve issues before they become disputes." },
        { title: "Building a Repeat Customer Base", order: 5, durationMins: 20, content: "Exceed expectations, follow up, be available, price fairly, remember details, ask for reviews." },
        { title: "Time Management and On-Time Delivery", order: 6, durationMins: 20, content: "On-Time Rate = 20 CouthActs Score points. Plan for worst, depart early, communicate delays immediately." },
      ],
      examQuestions: [
        { question: "How many Score points does Review Average contribute?", optionA: "10", optionB: "15", optionC: "20", optionD: "25", correctAnswer: "C", explanation: "Review Average contributes 20 points.", order: 1 },
        { question: "How soon after acceptance should you message?", optionA: "1 hour", optionB: "30 minutes", optionC: "2 hours", optionD: "24 hours", correctAnswer: "B", explanation: "Within 30 minutes of acceptance.", order: 2 },
        { question: "What does 'L' stand for in LAST framework?", optionA: "Lead", optionB: "Listen", optionC: "Learn", optionD: "Log", correctAnswer: "B", explanation: "LAST = Listen, Apologize, Solve, Thank.", order: 3 },
        { question: "What happens when a dispute is filed?", optionA: "Provider banned", optionB: "Escrow frozen immediately", optionC: "Payment released", optionD: "Nothing", correctAnswer: "B", explanation: "Escrow is frozen immediately pending review.", order: 4 },
        { question: "How many Score points does On-Time Rate contribute?", optionA: "10", optionB: "15", optionC: "20", optionD: "25", correctAnswer: "C", explanation: "On-Time Rate contributes 20 points.", order: 5 },
        { question: "Which tracking layer is for photo documentation?", optionA: "MOBILE_GPS", optionB: "IOT_DEVICE", optionC: "DOCUMENT_POD_AI", optionD: "SATELLITE", correctAnswer: "C", explanation: "DOCUMENT_POD_AI for timestamped, geotagged photos.", order: 6 },
      ],
    },
    {
      title: "Fleet Management Essentials",
      slug: "fleet-management-essentials",
      description: "Scale your transportation business. Fleet operations, driver management, route optimization, financial planning, and CouthActs API automation.",
      whatYouLearn: ["Fleet maintenance scheduling", "Driver recruitment and performance", "Route optimization and fuel efficiency", "Financial planning for transport businesses", "CouthActs API for fleet automation", "Scaling from single operator to fleet"],
      ...
      lessons: [
        { title: "Single Operator to Fleet Owner", order: 1, durationMins: 20, content: "Signs you're ready: consistently turning down jobs, Score 85+, strong reviews, 6 months capital saved." },
        { title: "Fleet Maintenance and Cost Control", order: 2, durationMins: 20, content: "Daily pre-trip, 5K-mile oil change, 15K brake inspection, 30K major service. Track cost per mile." },
        { title: "Driver Recruitment and Performance", order: 3, durationMins: 20, content: "Verify credentials, check references, set standards, pay bonuses for 5-star reviews and on-time delivery." },
        { title: "Route Optimization and Fuel Efficiency", order: 4, durationMins: 20, content: "Avoid empty miles via Load Board. Maintain tire pressure. Use cruise control. Reduce idle time." },
        { title: "Financial Planning", order: 5, durationMins: 20, content: "Revenue per mile, cost per mile, profit margin, utilization rate. Factor escrow fees into bidding." },
        { title: "Using the CouthActs API", order: 6, durationMins: 20, content: "Provider API: jobs, bookings, tracking, wallet endpoints. Automate GPS tracking from fleet telematics." },
        { title: "Multi-Mode Expansion", order: 7, durationMins: 20, content: "Natural expansion paths: freight→heavy haul, courier→moving, taxi→medical, air cargo→private jet." },
        { title: "Enterprise Features and Volume Pricing", order: 8, durationMins: 20, content: "50+ jobs/month qualifies for Enterprise: custom escrow, dedicated account manager, white-label tracking." },
      ],
      examQuestions: [
        { question: "Recommended Score before scaling to fleet?", optionA: "70+", optionB: "75+", optionC: "80+", optionD: "85+", correctAnswer: "D", explanation: "Score 85+ before scaling.", order: 1 },
        { question: "Benchmark cost per mile for commercial trucks?", optionA: "$0.50-1.00", optionB: "$1.00-1.50", optionC: "$1.50-2.50", optionD: "$3.00-4.00", correctAnswer: "C", explanation: "$1.50-2.50 per mile benchmark.", order: 2 },
        { question: "API endpoint for fleet tracking automation?", optionA: "POST /api/v1/jobs", optionB: "POST /api/provider/v1/tracking", optionC: "GET /api/track/{code}", optionD: "POST /api/tracking", correctAnswer: "B", explanation: "POST /api/provider/v1/tracking for pushing updates.", order: 3 },
        { question: "Days of operating expenses to keep in reserve?", optionA: "30", optionB: "45", optionC: "60", optionD: "90", correctAnswer: "C", explanation: "At least 60 days reserve.", order: 4 },
        { question: "Target utilization rate for long-haul?", optionA: "60%+", optionB: "70%+", optionC: "80%+", optionD: "90%+", correctAnswer: "C", explanation: "80%+ for long-haul operations.", order: 5 },
        { question: "Monthly jobs to qualify for Enterprise?", optionA: "20+", optionB: "30+", optionC: "40+", optionD: "50+", correctAnswer: "D", explanation: "50+ jobs/month for Enterprise.", order: 6 },
        { question: "Fuel burned by one hour of idling (diesel)?", optionA: "0.3-0.5 gal", optionB: "0.5-0.7 gal", optionC: "0.8-1.0 gal", optionD: "1.2-1.5 gal", correctAnswer: "C", explanation: "0.8-1.0 gallons per hour idling.", order: 7 },
        { question: "CouthActs live API key prefix?", optionA: "ca_test_", optionB: "ca_live_", optionC: "ca_prod_", optionD: "ca_api_", correctAnswer: "B", explanation: "Live keys start with ca_live_.", order: 8 },
      ],
    },
  ];
  ...
  for (const courseData of courses) {
    ...
    console.log(`✓ ${courseData.title} (${courseData.lessons.length} lessons, ${courseData.examQuestions.length} questions)`);
  }

  console.log(`\nDone! ${courses.length} courses seeded.`);
}
