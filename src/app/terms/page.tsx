  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7]">
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        <h1 className="text-3xl font-display font-bold tracking-tight text-[#1D1D1F] sm:text-4xl">Terms of Service</h1>
        ...
        <div className="mt-10 max-w-none space-y-8 text-[14px] text-[#6E6E73] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">2. Platform Description</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">3. Eligibility and Registration</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">5. The Escrow Service</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">6. Posting Fees</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">7. CouthActs Protection</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">8. CouthActs Advance</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">9. CouthActs Academy</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">10. APIs</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">11. The CouthActs Wallet</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">12. CouthActs Score</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">13. Provider Obligations</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">14. Cancellation Policy</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">15. Dispute Resolution</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">16. Prohibited Uses</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">17. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">18. Indemnification</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">19. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">20. Governing Law</h2>
          ...
          <section>
            <h2 className="text-lg font-display font-semibold text-[#1D1D1F]">21. Contact</h2>
