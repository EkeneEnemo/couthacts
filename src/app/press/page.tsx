      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16 sm:py-20">
        ...
        <section className="mt-16 rounded-[2rem] bg-white border border-[#1D1D1F]/5 p-8 sm:p-10 shadow-[0_4px_30px_rgba(0,0,0,0.03)]">
          ...
          <p className="mt-6 text-[15px] text-[#1D1D1F]/65 leading-relaxed">
            ...
            are wholly owned by <strong className="text-[#1D1D1F]">Enemo Consulting Group, Inc.</strong>;
            CouthActs&#8482;, Inc. operates under license from Enemo Consulting Group, Inc.
          </p>
        </section>
        ...
        <section className="mt-16">
          ...
          <ul className="mt-8 space-y-3">
            {[
              ...
              <>When referencing the corporate structure: <strong className="text-[#1D1D1F]">CouthActs&#8482;, Inc.</strong> (Texas corporation, operator, wholly owned subsidiary) &middot; <strong className="text-[#1D1D1F]">The Ravine of Willows, Inc.</strong> (Texas corporation, parent) &middot; <strong className="text-[#1D1D1F]">Enemo Consulting Group, Inc.</strong> (IP &amp; trademark owner)</>,
