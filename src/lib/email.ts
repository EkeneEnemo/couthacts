...
function wrap(body: string, userId?: string): string {
  ...
  const ownership = `&copy; ${year} CouthActs&trade;, Inc., a Texas corporation. A wholly owned subsidiary of The Ravine of Willows, Inc., also a Texas corporation. All intellectual property wholly owned by Enemo Consulting Group, Inc.&reg;`;
