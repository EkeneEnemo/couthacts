      ...
      <div className="relative mx-auto max-w-3xl px-6 py-16 sm:py-20">
        ...
        <div className="mt-12 rounded-[2rem] bg-white border border-[#1D1D1F]/5 p-8 sm:p-10 lg:p-12 shadow-[0_4px_30px_rgba(0,0,0,0.03)] space-y-8 text-[14px] text-[#1D1D1F]/65 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3"><strong className="text-[#1D1D1F]">CouthActs&#8482;, Inc.</strong> (&quot;CouthActs,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting your privacy. This policy explains what data we collect, how we use it, and your rights. CouthActs&#8482;, Inc. is a wholly owned subsidiary of <strong className="text-[#1D1D1F]">The Ravine of Willows, Inc.</strong>, a Texas corporation.</p>
            <p className="mt-3">For purposes of applicable data protection law (including the GDPR and UK GDPR), the data controller is <strong className="text-[#1D1D1F]">CouthActs&#8482;, Inc.</strong>, with its principal place of business at The Adolphus Tower, 1412 Main Street, STE 609, Dallas, TX 75202, United States. The CouthActs platform&apos;s underlying intellectual property is wholly owned by Enemo Consulting Group, Inc.&reg;, and CouthActs&#8482;, Inc. operates under license from Enemo Consulting Group, Inc.&reg;</p>
          </section>
