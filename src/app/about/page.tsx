...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-cream-50">
      ...
      {/* ═══════════════════════ HERO ═══════════════════════ */}
      <section className="relative overflow-hidden bg-ocean-900 min-h-[70vh] flex items-center">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-b from-ocean-900/60 via-ocean-900/80 to-ocean-900" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-4xl font-display font-black leading-[1.05] tracking-tight text-white sm:text-5xl lg:text-6xl">
              Built to move
              <br />
      ...
      {/* ═══════════════════════ SCALE NUMBERS ═══════════════════════ */}
      <section className="bg-ocean-900 border-t border-white/[0.06]">
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-2xl shadow-ocean-900/10">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                <p className="text-sm text-sky-100/70">Dallas, Texas</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-2xl border border-gray-100 bg-cream-50 p-10 lg:p-12">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-ocean-900 text-white">
                <Target className="h-5 w-5" />
              </div>
              <h3 className="mt-6 text-2xl font-display font-bold text-ocean-900">
                Our Mission
              </h3>
      ...
      <section className="bg-ocean-900 relative overflow-hidden">
        <div className="absolute inset-0 opacity-[0.03]">
          <div className="absolute top-0 right-0 h-[800px] w-[800px] rounded-full bg-sky-300 blur-[200px]" />
        </div>
        <div className="relative mx-auto max-w-7xl px-6 py-24 lg:py-32">
          ...
          <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={d.title}
                className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-7 transition-all hover:bg-white/[0.06]"
              >
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={v.title}
                className="rounded-2xl border border-gray-100 bg-white p-8 transition-all hover:shadow-lg hover:shadow-ocean-900/5"
              >
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-ocean-50">
                  <v.icon className="h-5 w-5 text-ocean-700" />
                </div>
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={t.label}
                  className="rounded-2xl border border-gray-100 bg-cream-50 p-5 transition-all hover:shadow-md"
                >
                  <t.icon className="h-5 w-5 text-ocean-700" />
                  <p className="mt-3 text-sm font-semibold text-ocean-900">
                    {t.label}
                  </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 lg:py-32">
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={c.label}
                className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-7"
              >
          ...
          <div className="mt-12 text-center">
            <p className="text-sm text-sky-200/40">
              ...
              <a
                ...
                className="text-sky-300 hover:text-white transition font-medium"
              >
                hello@couthacts.com
              </a>
            </p>
      ...
      <section className="bg-cream-50">
        <div className="mx-auto max-w-4xl px-6 py-28 lg:py-36 text-center">
          <h2 className="text-4xl font-display font-black tracking-tight text-ocean-900 sm:text-5xl">
            Ready to move?
          </h2>
          ...
          <div className="grid gap-12 lg:grid-cols-5">
            ...
            <div className="grid grid-cols-3 gap-8 lg:col-span-3">
              <div className="space-y-3 text-sm">
                ...
                <Link href="/government" className="block text-sky-200/50 hover:text-white transition">Government</Link>
              </div>
              <div className="space-y-3 text-sm">
                <p className="font-bold text-sky-300 text-xs uppercase tracking-wider">
                  Resources
                </p>
                <Link href="/about" className="block text-sky-200/50 hover:text-white transition">About</Link>
                <Link href="/academy" className="block text-sky-200/50 hover:text-white transition">Academy</Link>
                <Link href="/advance" className="block text-sky-200/50 hover:text-white transition">Advance</Link>
                <Link href="/api-docs" className="block text-sky-200/50 hover:text-white transition">API Docs</Link>
